...
namespace FreeSimEditor
{
    ...
    public class ObjectSelectionActionsView : ActionsView
    {
        ...
        private ObjectSelectionActionsViewData ViewData
        {
            get
            {
                if (_viewData == null) _viewData = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionActionsViewData>();
                return _viewData;
            }
        }
        #endregion
        ...
        protected override void RenderContent()
        {
            ...
            {
                FreeSimWorldBuilder.ActiveInstance.EditorWindowPool.SelectionGrabSettingsWindow.ObjectGrabSettings = ObjectSelection.Get().SelectionGrabSettings;
                FreeSimWorldBuilder.ActiveInstance.EditorWindowPool.SelectionGrabSettingsWindow.ShowFreeSimWindow();
            }
            EditorGUILayout.EndHorizontal();
