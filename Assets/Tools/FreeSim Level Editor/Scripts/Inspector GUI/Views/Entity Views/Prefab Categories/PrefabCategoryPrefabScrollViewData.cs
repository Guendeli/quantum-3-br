...
namespace FreeSimEditor
{
    ...
    public class PrefabCategoryPrefabScrollViewData : ScriptableObject
    {
        ...
        public PrefabCategoryScrollViewLookAndFeelWindow LookAndFeelWindow
        {
            get
            {
                if (_lookAndFeelWindow == null) _lookAndFeelWindow = FreeSimWorldBuilder.ActiveInstance.EditorWindowPool.CreateWindow<PrefabCategoryScrollViewLookAndFeelWindow>();
