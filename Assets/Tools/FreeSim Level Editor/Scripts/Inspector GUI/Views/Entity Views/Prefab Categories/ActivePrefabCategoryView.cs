...
namespace FreeSimEditor
{
    ...
    public class ActivePrefabCategoryView : EntityView
    {
        ...
        private ActivePrefabCategoryViewData ViewData
        {
            get
            {
                if (_viewData == null) _viewData = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ActivePrefabCategoryViewData>();
                return _viewData;
            }
        }
        #endregion
        ...
        protected override void RenderContent()
        {
            ...
            {
                FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("Note: When a config is loaded, the tool will use the prefab path to load the prefab back. If the prefab's path has changed (e.g. moved to " +
                ...
                FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("When a config is saved, all prefab categories (together with their prefabs) and prefab tags are saved. When a config is loaded, " +
            ...
            {
                _prefabScrollView.LookAndFeelWindow.ShowFreeSimWindow();
            }
            EditorGUILayout.EndHorizontal();
        ...
        {
            ObjectGroupDatabase objectGroupDatabase = FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase;
        ...
        private void RenderPrefabsToActiveCategoryDropOperationSettingsButton()
        {
            ...
            {
                PrefabsToCategoryDropSettingsWindow.Get().ShowFreeSimWindow();
            }
        }
