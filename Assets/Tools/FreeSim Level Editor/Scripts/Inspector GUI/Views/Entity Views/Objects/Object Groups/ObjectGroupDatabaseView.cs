...
namespace FreeSimEditor
{
    ...
    public class ObjectGroupDatabaseView : EntityView
    {
        ...
        private ObjectGroupDatabaseViewData ViewData
        {
            get
            {
                if (_viewData == null) _viewData = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectGroupDatabaseViewData>();
                return _viewData;
            }
        }
        #endregion
        ...
        private void RenderActionControls()
        {
            ...
            if (GUILayout.Button(content, GUILayout.Width(100.0f)))
            {
                ObjectGroup objectGroup = FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.ActiveGroup;
                if (objectGroup != null && objectGroup.GroupObject != null)
                {
                    FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.MakeNoLongerGroup(objectGroup.GroupObject);
                }
            }
            ...
            if (GUILayout.Button(content, GUILayout.Width(100.0f)))
            {
                ...
                if (objectGroup != null && objectGroup.GroupObject != null)
                {
                    FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.MakeAllNoLongerGroup();
                }
            }
