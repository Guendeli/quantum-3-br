...
namespace FreeSimEditor
{
    ...
    public class DecorPaintObjectPlacementBrushView : EntityView
    {
        ...
        private DecorPaintBrushViewData Data
        {
            get
            {
                if (_data == null) _data = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<DecorPaintBrushViewData>();
                return _data;
            }
        }
        ...
        protected override void RenderContent()
        {
            ...
            if (!_brush.IsEmpty) FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("Left click on an element's preview to change its parameters. Right click to remove the element from the brush. SHIFT + Right click to toggle the element on/off.");
            ...
            {
                FreeSimWorldBuilder.ActiveInstance.EditorWindowPool.DecorPaintBrushViewLookAndFeelWindow.ViewData = Data;
                FreeSimWorldBuilder.ActiveInstance.EditorWindowPool.DecorPaintBrushViewLookAndFeelWindow.ShowFreeSimWindow();
            }
            EditorGUILayout.EndHorizontal();
