...
{
    [Serializable]
    public class FreeSimConfigSaveLoadSettingsView : SettingsView
    {
        #region Private Variables
        [NonSerialized]
        private FreeSimConfigSaveLoadSettings _settings;
        #endregion

        #region Constructors
        public FreeSimConfigSaveLoadSettingsView(FreeSimConfigSaveLoadSettings settings)
        {
            _settings = settings;
        }
        #endregion
