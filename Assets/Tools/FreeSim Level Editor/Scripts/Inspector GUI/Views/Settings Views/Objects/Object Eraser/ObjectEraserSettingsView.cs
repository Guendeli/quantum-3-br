...
namespace FreeSimEditor
{
    ...
    public class ObjectEraserSettingsView : SettingsView
    {
        ...
        {
            FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("Usually, you will want to allow Undo/Redo for object erasing. However, please keep in mind that this can " + 
            ...
            {
                FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("This erase mode is ideal for performing quick clean-ups in your game level. Please keep in mind that " + 
            ...
            {
                FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("The 3D brush is great for erasing large amount of objects quickly and efficiently. One thing to keep in mind is that " + 
