...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathTileConnectionSettingsView : SettingsView
    {
        ...
        protected override void RenderContent()
        {
            ...
            {
                FreeSimWorldBuilder.ActiveInstance.ShowGUIHint("When using tile connections, the extension plane will always reside at the bottom of the placement guide in its local space.");
