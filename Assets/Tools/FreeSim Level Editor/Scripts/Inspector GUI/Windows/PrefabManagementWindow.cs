...
{
    [Serializable]
    public class PrefabManagementWindow : FreeSimEditorWindow, IMessageListener
    {
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.PrefabManagementWindow;
        }
        #endregion
        ...
        {
            FreeSimWorldBuilder.ActiveInstance.ActivePrefabCategoryView.Render();
            FreeSimWorldBuilder.ActiveInstance.ActivePrefabView.Render();
        }
        #endregion
    }
}
