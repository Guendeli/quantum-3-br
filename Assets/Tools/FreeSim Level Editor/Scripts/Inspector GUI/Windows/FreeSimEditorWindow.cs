...
{
    [Serializable]
    public abstract class FreeSimEditorWindow : EditorWindow
    {
        ...
        public static T Create<T>() where T : FreeSimEditorWindow
        {
        ...
        public static void Destroy<T>(T window) where T : FreeSimEditorWindow
        {
        ...
        public void RepaintFreeSimWindow()
        {
        ...
        public abstract void ShowFreeSimWindow();
