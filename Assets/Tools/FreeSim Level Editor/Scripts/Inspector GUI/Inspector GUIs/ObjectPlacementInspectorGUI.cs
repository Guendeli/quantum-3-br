...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementInspectorGUI : InspectorGUI
    {
        ...
        public override void Initialize()
        {
            ...
            ObjectGroupDatabaseView objectGroupDatabaseView = FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.View;
        ...
        public override void Render()
        {
            ...
            FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.View.Render();
