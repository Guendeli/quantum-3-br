...
namespace FreeSimEditor
{
    ...
    public class ObjectSnapSettings : ScriptableObject
    {
        ...
        public ObjectColliderSnapSurfaceGridSettings ObjectColliderSnapSurfaceGridSettings
        {
            get
            {
                if (_objectColliderSnapSurfaceGridSettings == null) _objectColliderSnapSurfaceGridSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectColliderSnapSurfaceGridSettings>();
