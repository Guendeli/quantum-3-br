...
namespace FreeSimEditor
{
    ...
    public class ProjectedBoxFacePivotPointsRenderSettings : ScriptableObject
    {
        ...
        { 
            get 
            {
                if (_activePivotPointRenderSettings == null) _activePivotPointRenderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<SingleObjectPivotPointRenderSettings>();
        ...
        { 
            get 
            {
                if (_inactivePivotPointRenderSettings == null) _inactivePivotPointRenderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<SingleObjectPivotPointRenderSettings>();
