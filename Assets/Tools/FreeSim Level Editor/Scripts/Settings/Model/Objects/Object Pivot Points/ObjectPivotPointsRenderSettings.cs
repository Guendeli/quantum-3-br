...
namespace FreeSimEditor
{
    ...
    public class ObjectPivotPointsRenderSettings : ScriptableObject
    {
        ...
        public ProjectedBoxFacePivotPointsRenderSettings ProjectedBoxFacePivotPointsRenderSettings
        {
            get
            {
                if (_projectedBoxFacePivotPointsRenderSettings == null) _projectedBoxFacePivotPointsRenderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ProjectedBoxFacePivotPointsRenderSettings>();
