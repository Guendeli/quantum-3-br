...
namespace FreeSimEditor
{
    ...
    public class ObjectEraserSettings : ScriptableObject
    {
        ...
        public Object2DMassEraseSettings Mass2DEraseSettings
        {
            get
            {
                if (_mass2DEraseSettings == null) _mass2DEraseSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<Object2DMassEraseSettings>();
        ...
        public Object3DMassEraseSettings Mass3DEraseSettings
        {
            get
            {
                if (_mass3DEraseSettings == null) _mass3DEraseSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<Object3DMassEraseSettings>();
