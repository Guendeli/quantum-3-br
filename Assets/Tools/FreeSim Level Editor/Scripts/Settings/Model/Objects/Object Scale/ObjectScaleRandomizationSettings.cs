...
namespace FreeSimEditor
{
    ...
    public class ObjectScaleRandomizationSettings : ScriptableObject
    {
        ...
        public ObjectUniformScaleRandomizationSettings UniformScaleRandomizationSettings
        {
            get
            {
                if (_uniformScaleRandomizationSettings == null) _uniformScaleRandomizationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectUniformScaleRandomizationSettings>();
