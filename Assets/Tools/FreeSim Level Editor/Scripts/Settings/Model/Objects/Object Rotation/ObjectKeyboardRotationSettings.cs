    ...
    public class ObjectKeyboardRotationSettings : ScriptableObject
    {
        ...
        public AxisKeyboardRotationSettings XAxisRotationSettings
        {
            get
            {
                ...
                {
                    _xAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisKeyboardRotationSettings>();
        ...
        public AxisKeyboardRotationSettings YAxisRotationSettings
        {
            get
            {
                ...
                {
                    _yAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisKeyboardRotationSettings>();
        ...
        public AxisKeyboardRotationSettings ZAxisRotationSettings
        {
            get
            {
                ...
                {
                    _zAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisKeyboardRotationSettings>();
        ...
        public CustomAxisKeyboardRotationSettings CustomAxisRotationSettings
        {
            get
            {
                if (_customAxisRotationSettings == null) _customAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<CustomAxisKeyboardRotationSettings>();
