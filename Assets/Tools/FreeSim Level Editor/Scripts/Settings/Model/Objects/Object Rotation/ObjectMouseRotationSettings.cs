    ...
    public class ObjectMouseRotationSettings : ScriptableObject
    {
        ...
        public AxisMouseRotationSettings XAxisRotationSettings
        {
            get
            {
                ...
                {
                    _xAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisMouseRotationSettings>();
        ...
        public AxisMouseRotationSettings YAxisRotationSettings
        {
            get
            {
                ...
                {
                    _yAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisMouseRotationSettings>();
        ...
        public AxisMouseRotationSettings ZAxisRotationSettings
        {
            get
            {
                ...
                {
                    _zAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisMouseRotationSettings>();
        ...
        public CustomAxisMouseRotationSettings CustomAxisRotationSettings
        {
            get
            {
                if (_customAxisRotationSettings == null) _customAxisRotationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<CustomAxisMouseRotationSettings>();
