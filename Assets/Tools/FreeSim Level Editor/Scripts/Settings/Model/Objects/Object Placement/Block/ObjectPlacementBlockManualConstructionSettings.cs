...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementBlockManualConstructionSettings : ScriptableObject
    {
        ...
        public ObjectPlacementBlockPaddingSettings PaddingSettings
        {
            get
            {
                if (_paddingSettings == null) _paddingSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockPaddingSettings>();
        ...
        public ObjectRotationRandomizationSettings ObjectRotationRandomizationSettings
        {
            get
            {
                if (_objectRotationRandomizationSettings == null) _objectRotationRandomizationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectRotationRandomizationSettings>();
        ...
        public ObjectPlacementBlockHeightAdjustmentSettings HeightAdjustmentSettings
        {
            get
            {
                if (_heightAdjustmentSettings == null) _heightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockHeightAdjustmentSettings>();
        ...
        public ObjectPlacementBlockSubdivisionSettings SubdivisionSettings
        {
            get
            {
                if (_subdivisionSettings == null) _subdivisionSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockSubdivisionSettings>();
