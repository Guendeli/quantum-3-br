...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementBlockHeightAdjustmentSettings : ScriptableObject
    {
        ...
        public ObjectPlacementBlockManualHeightAdjustmentSettings ManualHeightAdjustmentSettings
        {
            get
            {
                if (_manualHeightAdjustmentSettings == null) _manualHeightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockManualHeightAdjustmentSettings>();
        ...
        public ObjectPlacementBlockAutomaticRandomHeightAdjustmentSettings AutomaticRandomHeightAdjustmentSettings
        {
            get
            {
                if (_automaticRandomHeightAdjustmentSettings == null) _automaticRandomHeightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockAutomaticRandomHeightAdjustmentSettings>();
