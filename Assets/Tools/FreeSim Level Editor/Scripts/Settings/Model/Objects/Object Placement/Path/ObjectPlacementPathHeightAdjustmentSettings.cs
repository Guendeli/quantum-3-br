...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathHeightAdjustmentSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathManualHeightAdjustmentSettings ManualHeightAdjustmentSettings
        {
            get
            {
                if (_manualHeightAdjustmentSettings == null) _manualHeightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathManualHeightAdjustmentSettings>();
        ...
        public ObjectPlacementPathAutomaticRandomHeightAdjustmentSettings AutomaticRandomHeightAdjustmentSettings
        {
            get
            {
                if (_automaticRandomHeightAdjustmentSettings == null) _automaticRandomHeightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathAutomaticRandomHeightAdjustmentSettings>();
        ...
        public ObjectPlacementPathAutomaticPatternHeightAdjustmentSettings AutomaticPatternHeightAdjustmentSettings
        {
            get
            {
                if (_automaticPatternHeightAdjustmentSettings == null) _automaticPatternHeightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathAutomaticPatternHeightAdjustmentSettings>();
