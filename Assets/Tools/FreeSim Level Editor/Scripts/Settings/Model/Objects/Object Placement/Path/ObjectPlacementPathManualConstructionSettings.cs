...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathManualConstructionSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathPaddingSettings PaddingSettings
        {
            get
            {
                if (_paddingSettings == null) _paddingSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathPaddingSettings>();
        ...
        public ObjectPlacementPathHeightAdjustmentSettings HeightAdjustmentSettings
        {
            get
            {
                if (_heightAdjustmentSettings == null) _heightAdjustmentSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathHeightAdjustmentSettings>();
        ...
        public ObjectPlacementPathBorderSettings BorderSettings
        {
            get
            {
                if (_borderSettings == null) _borderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathBorderSettings>();
