...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementSettings : ScriptableObject
    {
        ...
        public ObjectIntersectionSettings ObjectIntersectionSettings
        {
            get
            {
                if (_objectIntersectionSettings == null) _objectIntersectionSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectIntersectionSettings>();
        ...
        public ObjectPlacementGuideSettings ObjectPlacementGuideSettings
        {
            get
            {
                if (_objectPlacementGuideSettings == null) _objectPlacementGuideSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementGuideSettings>();
        ...
        public DecorPaintObjectPlacementSettings DecorPaintObjectPlacementSettings
        {
            get
            {
                if (_decorPaintObjectPlacementSettings == null) _decorPaintObjectPlacementSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<DecorPaintObjectPlacementSettings>();
        ...
        public PointAndClickObjectPlacementSettings PointAndClickPlacementSettings
        {
            get
            {
                if (_pointAndClickPlacementSettings == null) _pointAndClickPlacementSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PointAndClickObjectPlacementSettings>();
        ...
        public PathObjectPlacementSettings PathPlacementSettings
        {
            get
            {
                if (_pathPlacementSettings == null) _pathPlacementSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PathObjectPlacementSettings>();
        ...
        public BlockObjectPlacementSettings BlockObjectPlacementSettings
        {
            get
            {
                if (_blockObjectPlacementSettings == null) _blockObjectPlacementSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<BlockObjectPlacementSettings>();
