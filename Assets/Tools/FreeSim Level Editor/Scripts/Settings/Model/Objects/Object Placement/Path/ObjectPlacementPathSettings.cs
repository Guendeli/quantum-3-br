...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathManualConstructionSettings ManualConstructionSettings
        {
            get
            {
                if (_manualConstructionSettings == null) _manualConstructionSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathManualConstructionSettings>();
        ...
        public ObjectPlacementPathTileConnectionSettings TileConnectionSettings
        {
            get
            {
                if (_tileConnectionSettings == null) _tileConnectionSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathTileConnectionSettings>();
