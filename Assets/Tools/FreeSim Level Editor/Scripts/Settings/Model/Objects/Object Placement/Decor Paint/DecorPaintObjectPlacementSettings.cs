...
namespace FreeSimEditor
{
    ...
    public class DecorPaintObjectPlacementSettings : ScriptableObject
    {
        ...
        public SingleDecorPaintModeObjectPlacementSettings SingleDecorPaintModeSettings
        {
            get
            {
                if (_singleDecorPaintModeSettings == null) _singleDecorPaintModeSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<SingleDecorPaintModeObjectPlacementSettings>();
        ...
        public BrushDecorPaintModeObjectPlacementSettings BrushDecorPaintModeSettings
        {
            get
            {
                if (_brushDecorPaintModeSettings == null) _brushDecorPaintModeSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<BrushDecorPaintModeObjectPlacementSettings>();
