...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementGuideSettings : ScriptableObject
    {
        ...
        public ObjectMouseMoveAlongDirectionSettings MouseOffsetFromPlacementSurfaceSettings
        {
            get
            {
                if (_mouseOffsetFromPlacementSurfaceSettings == null) _mouseOffsetFromPlacementSurfaceSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectMouseMoveAlongDirectionSettings>();
        ...
        public ObjectMouseUniformScaleSettings MouseUniformScaleSettings
        {
            get
            {
                if (_mouseUniformScaleSettings == null) _mouseUniformScaleSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectMouseUniformScaleSettings>();
