...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathRenderSettings : ScriptableObject
    {
        ...
        public ObjectPlacementPathManualConstructionRenderSettings ManualConstructionRenderSettings
        {
            get
            {
                if (_manualConstructionRenderSettings == null) _manualConstructionRenderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathManualConstructionRenderSettings>();
