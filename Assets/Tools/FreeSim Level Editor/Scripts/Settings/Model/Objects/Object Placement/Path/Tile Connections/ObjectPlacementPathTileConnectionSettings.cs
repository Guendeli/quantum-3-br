...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathTileConnectionSettings : ScriptableObject
    {
        ...
        private void InitializePathTileConnectionTypeSettingsArray()
        {
            ...
            {
                ObjectPlacementPathTileConnectionTypeSettings tileConnectionTypeSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathTileConnectionTypeSettings>();
