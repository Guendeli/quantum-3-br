...
namespace FreeSimEditor
{
    ...
    public class AxisRotationRandomizationSettings : ScriptableObject
    {
        ...
        public AxisRotationRandomizationModeSettings RandomizationModeSettings
        {
            get
            {
                if (_randomizationModeSettings == null) _randomizationModeSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<AxisRotationRandomizationModeSettings>();
