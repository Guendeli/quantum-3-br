...
namespace FreeSimEditor
{
    ...
    public class AxisRotationRandomizationModeSettings : ScriptableObject
    {
        ...
        public RandomRotationStepAxisRandomizationSettings RandomRotationStepAxisRandomizationSettings
        {
            get
            {
                if (_randomRotationStepAxisRandomizationSettings == null) _randomRotationStepAxisRandomizationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<RandomRotationStepAxisRandomizationSettings>();
        ...
        public RandomRotationValueAxisRandomizationSettings RandomRotationValueAxisRandomizationSettings
        {
            get
            {
                if (_randomRotationValueAxisRandomizationSettings == null) _randomRotationValueAxisRandomizationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<RandomRotationValueAxisRandomizationSettings>();
