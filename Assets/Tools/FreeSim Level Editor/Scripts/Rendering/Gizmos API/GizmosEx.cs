...
namespace FreeSimEditor
{
    public static class GizmosEx
    {
        ...
        public static Mesh XZRectangleMesh
        {
            get
            {
                if (_xzRectangleMesh == null) _xzRectangleMesh = FreeSimWorldBuilder.ActiveInstance.ToolResources.MeshResources.CreateXZRectangleMesh(1.0f, 1.0f, Color.white);
        ...
        {
            if (_xyRectangleMesh == null) _xyRectangleMesh = FreeSimWorldBuilder.ActiveInstance.ToolResources.MeshResources.CreateXYRectangleMesh(1.0f, 1.0f, Color.white);
            return _xyRectangleMesh;
        }

        private static Mesh GetCircleMesh()
        {
            if (_xyCircleMesh == null) _xyCircleMesh = FreeSimWorldBuilder.ActiveInstance.ToolResources.MeshResources.CreateXYCircleMesh(1.0f, _numberOfCircleMeshSlices, Color.white);
