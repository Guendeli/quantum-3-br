...
namespace FreeSimEditor
{
    public class PrefabPreviewTextureCache
    {
        ...
        public static PrefabPreviewTextureCache Get()
        {
            ...
            return FreeSimWorldBuilder.ActiveInstance.ToolResources.PrefabPreviewTextureCache;
        }
        #endregion
        ...
        public void DisposeTextures()
        {
            ...
            {
                if (pair.Value != null) FreeSimWorldBuilder.DestroyImmediate(pair.Value, true);
            }
       ...
       /* private Texture2D ClonePrefabPreviewAndStore(Prefab prefab, Texture2D prefabPreview)
        ...
        private Dictionary<Prefab, Texture2D> GenerateNewDictionaryExcludingPairsWithNullPrefabReferences()
        {
            ...
            {
                if ((pair.Key == null || pair.Key.UnityPrefab == null) && pair.Value != null) FreeSimWorldBuilder.DestroyImmediate(pair.Value);
