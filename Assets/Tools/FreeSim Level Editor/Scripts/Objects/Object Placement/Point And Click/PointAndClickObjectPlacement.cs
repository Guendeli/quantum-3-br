...
namespace FreeSimEditor
{
    ...
    public class PointAndClickObjectPlacement
    {
        ...
        private void PlaceObject()
        {
            ...
            GameObject placedHierarchyRoot = FreeSimScene.Get().InstantiateObjectHierarchyFromPrefab(placementGuide.SourcePrefab, placementGuide.WorldPosition, placementGuide.WorldRotation, placementGuide.WorldScale);
