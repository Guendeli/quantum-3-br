...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacement : ScriptableObject, IMessageListener
    {
        ...
        public ObjectPlacementSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementSettings>();
                return _settings;
            }
        }
        public ObjectPivotPointsRenderSettings GuidePivotPointsRenderSettings
        {
            get
            {
                if (_guidePivotPointsRenderSettings == null) _guidePivotPointsRenderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPivotPointsRenderSettings>();
        ...
        public DecorPaintObjectPlacement DecorPaintObjectPlacement
        {
            get
            {
                if (_decorPaintObjectPlacement == null) _decorPaintObjectPlacement = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<DecorPaintObjectPlacement>();
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.ObjectPlacement;
        }
        #endregion
        ...
        public void HandleMouseScrollWheelEvent(Event e)
        {
            ...
            if (AllShortcutCombos.Instance.CycleThroughPrefabsInActiveCategoryUsingMouseScrollWheel.IsActive() && ObjectPlacementGuide.ExistsInScene)
            {
                ...
                if (Mathf.Abs(e.delta.y) <= 3.0f)
                {
                    ...
                    FreeSimWorldBuilder.ActiveInstance.PrefabManagementWindow.Repaint();
                }
            }
            else
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.ActiveGroup;
        }
        ...
        private bool CanAttachPlacedRootsAsChildrenOfHoveredObject(ObjectHierarchyRootsWerePlacedInSceneMessage.PlacementType objectPlacementType)
        {
            ...
            GameObject surfaceObject = ObjectPlacementSurfaceInfo.GetSurfaceObject();
            return Settings.MakePlacedObjectsChildrenOfHoveredObject && surfaceObject != null && FreeSimWorldBuilder.ActiveInstance.IsWorkingObject(surfaceObject);
        }
        ...
        {
            return ObjectPlacementMode != FreeSimEditor.ObjectPlacementMode.DecorPaint;
        }
        ...
        private bool PrefabActivationValidationCallback(Prefab prefabToActivate)
        {
            ...
            /*if (FreeSimWorldBuilder.Instance.Inspector.ActiveInspectorGUIIdentifier != InspectorGUIIdentifier.ObjectPlacement &&
                FreeSimWorldBuilder.Instance.Inspector.ActiveInspectorGUIIdentifier != InspectorGUIIdentifier.ObjectSnapping) return false;*/
            return true;
        }
