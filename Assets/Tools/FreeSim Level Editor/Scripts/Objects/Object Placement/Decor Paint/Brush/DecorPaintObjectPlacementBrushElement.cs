...
namespace FreeSimEditor
{
    ...
    public class DecorPaintObjectPlacementBrushElement : ScriptableObject
    {
        ...
        public ObjectScaleRandomizationSettings ScaleRandomizationSettings
        {
            get
            {
                if (_scaleRandomizationSettings == null) _scaleRandomizationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectScaleRandomizationSettings>();
        ...
        public DecorPaintSlopeSettings SlopeSettings
        {
            get
            {
                if (_slopeSettings == null) _slopeSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<DecorPaintSlopeSettings>();
