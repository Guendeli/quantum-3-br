...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementGuide : MonoBehaviour, IMessageListener
    {
        ...
        {
            if (ExistsInScene) FreeSimWorldBuilder.DestroyImmediate(ObjectPlacementGuide.Instance.gameObject);
        }
        #endregion
        ...
        private void OnEditorUpdate()
        {
            ...
            {
                if (FreeSimWorldBuilder.ActiveInstance == null) UndoEx.DestroyObjectImmediate(gameObject);
                else
                if (!Selection.Contains(FreeSimWorldBuilder.ActiveInstance.gameObject)) ObjectPlacement.Get().DestroyPlacementGuide();
            }
        }
        #endregion
