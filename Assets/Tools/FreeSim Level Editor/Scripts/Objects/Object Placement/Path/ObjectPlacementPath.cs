...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPath : IMessageListener
    {
        ...
        public ObjectPlacementPathSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathSettings>();
                return _settings;
            }
        }
        public ObjectPlacementPathRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathRenderSettings>();
