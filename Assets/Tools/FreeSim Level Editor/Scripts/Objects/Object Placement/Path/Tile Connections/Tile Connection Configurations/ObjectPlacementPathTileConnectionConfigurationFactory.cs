...
namespace FreeSimEditor
{
    public static class ObjectPlacementPathTileConnectionConfigurationFactory
    {
        ...
        {
            ObjectPlacementPathTileConnectionConfiguration newConfiguration = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathTileConnectionConfiguration>();
