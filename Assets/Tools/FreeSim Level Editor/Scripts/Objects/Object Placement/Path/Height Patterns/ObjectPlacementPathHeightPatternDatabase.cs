...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementPathHeightPatternDatabase : ScriptableObject
    {
        ...
        public ObjectPlacementPathHeightPatternFilter HeightPatternFilter
        {
            get
            {
                if (_heightPatternFilter == null) _heightPatternFilter = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementPathHeightPatternFilter>();
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.ObjectPlacementPathHeightPatternDatabase;
        }
        #endregion
