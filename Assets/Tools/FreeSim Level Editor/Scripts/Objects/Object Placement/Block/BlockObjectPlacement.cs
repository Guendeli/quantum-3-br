...
namespace FreeSimEditor
{
    ...
    public class BlockObjectPlacement
    {
        ...
        {
            List<GameObject> placedHierarchyRoots = FreeSimScene.Get().InstantiateObjectHirarchiesFromPlacementDataCollection(_objectPlacementBlock.EndManualConstruction());
