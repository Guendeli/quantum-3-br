...
namespace FreeSimEditor
{
    ...
    public class ObjectPlacementBlock : IMessageListener
    {
        ...
        public ObjectPlacementBlockSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockSettings>();
                return _settings;
            }
        }
        ...
        public ObjectPlacementBlockRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectPlacementBlockRenderSettings>();
