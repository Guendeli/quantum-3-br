...
namespace FreeSimEditor
{
    public class ObjectVertexSnapSession
    {
        ...
        public void Begin(List<GameObject> sourceObjects)
        {
            ...
            _sourceParents = FreeSimWorldBuilder.ActiveInstance.GetRoots(_sourceObjects);
            ...
            if (_state == ObjectVertexSnapSessionState.SelectSourceVertex)
            {
                if (_sourceObjects == null || _sourceObjects.Count == 0)
                {
                    ...
                    if (cursorRayHit.WasAnObjectHit)
                    {
                        ...
                        if (meshRayHit != null)
                        {
                            FreeSimMesh octaveMesh = meshRayHit.HitMesh;
        ...
        private void SnapToDestination()
        {
            ...
            {
                GameObject root = FreeSimWorldBuilder.ActiveInstance.GetRoot(_sourceObject);
                if (root != null)
                {
