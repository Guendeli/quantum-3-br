...
namespace FreeSimEditor
{
    ...
    public class ObjectSnapping : ScriptableObject
    {
        ...
        public ObjectSnapSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSnapSettings>();
                return _settings;
            }
        }
        public XZGrid XZSnapGrid
        {
            get
            {
                if (_xzSnapGrid == null) _xzSnapGrid = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<XZGrid>();
                return _xzSnapGrid;
            }
        }
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.ObjectSnapping;
        }
        #endregion
