...
namespace FreeSimEditor
{
    ...
    public class ObjectEraser : ScriptableObject
    {
        ...
        public ObjectEraserSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectEraserSettings>();
                return _settings;
            }
        }
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.ObjectEraser;
        }
        #endregion
