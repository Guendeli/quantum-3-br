    ...
    public class Object3DMassEraseShape
    {
        ...
        public List<GameObject> GetOverlappedGameObjectsForEraseOperation()
        {
            ...
            if(_circleShape.HasCursorPickedObject())
            {
                ...
                if(!FreeSimWorldBuilder.ActiveInstance.IsPivotWorkingObject(pickedGameObject))
                {
                    GameObject root = FreeSimWorldBuilder.ActiveInstance.GetRoot(pickedGameObject);
