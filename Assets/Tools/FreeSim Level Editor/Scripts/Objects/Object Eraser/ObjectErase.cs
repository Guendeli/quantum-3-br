...
namespace FreeSimEditor
{
    public static class ObjectErase
    {
        ...
        {
            HashSet<GameObject> rootsToErase = new HashSet<GameObject>(FreeSimWorldBuilder.ActiveInstance.GetRoots(gameObjectsToErase));
        ...
        public static void EraseGameObject(GameObject gameObject)
        {
            ...
            ObjectEraserSettings eraserSettings = ObjectEraserSettings.Get();
            bool isPivotWorkingObject = FreeSimWorldBuilder.ActiveInstance.IsPivotWorkingObject(gameObject);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (immediateParent.transform.childCount == 0 &&
                        ...
                        !FreeSimWorldBuilder.ActiveInstance.IsPivotWorkingObject(immediateParent)) DestroyGameObject(immediateParent, eraserSettings.AllowUndoRedo);
                }
            }
        }
        ...
        private static void DestroyGameObject(GameObject gameObject, bool allowUndoRedo)
        {
            ...
            else FreeSimWorldBuilder.DestroyImmediate(gameObject);
        }
