...
namespace FreeSimEditor
{
    ...
    public class ObjectMask
    {
        ...
        public ObjectLayerObjectMask ObjectLayerObjectMask
        {
            get
            {
                if (_objectLayerObjectMask == null) _objectLayerObjectMask = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectLayerObjectMask>();
        ...
        public ObjectCollectionMask ObjectCollectionMask
        {
            get
            {
                if (_objectCollectionMask == null) _objectCollectionMask = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectCollectionMask>();
