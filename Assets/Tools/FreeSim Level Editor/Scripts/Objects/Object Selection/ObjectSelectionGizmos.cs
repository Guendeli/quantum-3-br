...
namespace FreeSimEditor
{
    ...
    public class ObjectSelectionGizmos: ScriptableObject
    {
        ...
        public ObjectMoveGizmo ObjectMoveGizmo
        {
            get
            {
                if (_objectMoveGizmo == null) _objectMoveGizmo = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectMoveGizmo>();
        ...
        public ObjectRotationGizmo ObjectRotationGizmo
        {
            get
            {
                if (_objectRotationGizmo == null) _objectRotationGizmo = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectRotationGizmo>();
        ...
        public ObjectScaleGizmo ObjectScaleGizmo
        {
            get
            {
                if (_objectScaleGizmo == null) _objectScaleGizmo = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectScaleGizmo>();
        ...
        public ObjectSelectionExtrudeGizmo ObjectDuplicateGizmo
        {
            get
            {
                if (_objectDuplicateGizmo == null) _objectDuplicateGizmo = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionExtrudeGizmo>();
