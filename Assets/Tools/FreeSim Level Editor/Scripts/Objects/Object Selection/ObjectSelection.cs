...
namespace FreeSimEditor
{
    ...
    public class ObjectSelection : ScriptableObject
    {
        ...
        private ObjectSelectionExtrudeGizmo DuplicateGizmo
        {
            get
            {
                if (_duplicateGizmo == null) _duplicateGizmo = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionExtrudeGizmo>();
        ...
        public ObjectVertexSnapSessionRenderSettings ObjectVertexSnapSessionRenderSettings
        {
            get
            {
                if (_objectVertexSnapSessionRenderSettings == null) _objectVertexSnapSessionRenderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectVertexSnapSessionRenderSettings>();
        ...
        public InteractableMirror Mirror
        {
            get
            {
                if (_mirror == null) _mirror = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<InteractableMirror>();
                return _mirror;
            }
        }
        ...
        public ObjectOnSurfaceProjectSettings ObjectOnSurfaceProjectSettings
        {
            get
            {
                if (_objectOnSurfaceProjectSettings == null) _objectOnSurfaceProjectSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectOnSurfaceProjectSettings>();
        ...
        public ObjectSelectionGizmos ObjectSelectionGizmos
        {
            get
            {
                if (_objectSelectionGizmos == null) _objectSelectionGizmos = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionGizmos>();
        ...
        public ObjectSelectionSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionSettings>();
                return _settings;
            }
        }
        public ObjectSelectionPrefabCreationSettings PrefabCreationSettings
        {
            get
            {
                if (_prefabCreationSettings == null) _prefabCreationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionPrefabCreationSettings>();
        ...
        public ObjectSelectionRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectSelectionRenderSettings>();
        ...
        public ObjectGrabSettings SelectionGrabSettings
        {
            get
            {
                if (_selectionGrabSettings == null) _selectionGrabSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<ObjectGrabSettings>();
        ...
        {
            if (FreeSimWorldBuilder.ActiveInstance == null) return null;
            return FreeSimWorldBuilder.ActiveInstance.ObjectSelection;
        }
        #endregion
        ...
        public void AddEntireGameObjectHierarchyToSelection(GameObject gameObjectInHierarchy)
        {
            ...
            GameObject root = FreeSimWorldBuilder.ActiveInstance.GetRoot(gameObjectInHierarchy);
        ...
        {
            GameObject root = FreeSimWorldBuilder.ActiveInstance.GetRoot(gameObject);
            List<GameObject> allChildrenIncludingSelf = root.GetAllChildrenIncludingSelf();
        ...
        public void HandleKeyboardButtonDownEvent(Event e)
        {
            ...
            {
                List<GameObject> selectedRoots = FreeSimWorldBuilder.ActiveInstance.GetRoots(GetAllSelectedGameObjects());
            ...
            if (AllShortcutCombos.Instance.ActivateMoveGizmo.IsActive())
            {
                ...
                FreeSimWorldBuilder.ActiveInstance.Inspector.EditorWindow.Repaint();
            }
            else
