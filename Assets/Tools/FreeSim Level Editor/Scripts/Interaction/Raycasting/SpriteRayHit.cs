...
namespace FreeSimEditor
{
    public class SpriteRayHit
    {
        ...
        private FreeSimBoxCollider _hitCollider;
        ...
        public FreeSimBoxCollider HitCollider { get { return _hitCollider; } }
        ...
        public SpriteRayHit(Ray ray, float hitEnter, SpriteRenderer hitSpriteRenderer, Vector3 hitPoint, Vector3 hitNormal)
        {
            ...
            _hitCollider = new FreeSimBoxCollider(hitSpriteRenderer.gameObject.GetWorldOrientedBox());
            _hitPoint = hitPoint;
