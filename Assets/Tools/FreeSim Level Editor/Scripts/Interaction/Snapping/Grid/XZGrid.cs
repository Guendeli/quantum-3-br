...
namespace FreeSimEditor
{
    ...
    public class XZGrid : ScriptableObject
    {
        ...
        public XZGridRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<XZGridRenderSettings>();
        ...
        public XZGridCellSizeSettings CellSizeSettings
        {
            get
            {
                if (_cellSizeSettings == null) _cellSizeSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<XZGridCellSizeSettings>();
