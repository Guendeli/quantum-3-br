...
namespace FreeSimEditor
{
    ...
    public class InteractableMirror : ScriptableObject
    {
        ...
        private static string MirrorObjectName { get { return "FreeSim Mirror Object"; } }
        #endregion
        ...
        public InteractableMirrorSettings Settings
        {
            get
            {
                if (_settings == null) _settings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<InteractableMirrorSettings>();
                return _settings;
            }
        }
        public InteractableMirrorRenderSettings RenderSettings
        {
            get
            {
                if (_renderSettings == null) _renderSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<InteractableMirrorRenderSettings>();
        ...
        public GameObject MirrorGameObjectHierarchy(GameObject hierarchyRoot, Prefab sourcePrefab)
        {
            ...
            if (sourcePrefab != null) mirroredHierarchyRoot = FreeSimScene.Get().InstantiateObjectHierarchyFromPrefab(sourcePrefab, hierarchyRootTransform.position, hierarchyRootTransform.rotation, hierarchyRootTransform.lossyScale);
        ...
        {
            if (_isInteractionSessionActive) FreeSimWorldBuilder.ActiveInstance.Inspector.EditorWindow.Repaint();
        ...
        private void CreateSessionMirrorObject()
        {
            ...
            // Note: It is important to not attach as a child of the FreeSim tool object. Otherwise
            //       serialization hell happens when: 'Remove Component' for FreeSim and then Undo.
