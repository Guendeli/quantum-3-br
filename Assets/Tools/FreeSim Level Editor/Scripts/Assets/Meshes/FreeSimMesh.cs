...
namespace FreeSimEditor
{
    ...
    public class FreeSimMesh
    {
        ...
        public bool IntersectsMesh(TransformMatrix thisTransform, FreeSimMesh otherMesh, TransformMatrix otherTransform)
        {
        ...
        public List<Triangle3DIntersectInfo> GetIntersectingTriangles(TransformMatrix thisTransform, FreeSimMesh otherMesh, TransformMatrix otherTransform)
        {
            OrientedBox thisOOBB = new OrientedBox(ModelAABB);
            thisOOBB.Transform(thisTransform);
            OrientedBox otherOOBB = new OrientedBox(otherMesh.ModelAABB);
