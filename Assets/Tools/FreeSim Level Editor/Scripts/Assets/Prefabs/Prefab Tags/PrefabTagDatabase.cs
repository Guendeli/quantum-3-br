...
namespace FreeSimEditor
{
    ...
    public class PrefabTagDatabase : ScriptableObject
    {
        ...
        public PrefabTagFilter PrefabTagFilter
        {
            get
            {
                if (_prefabTagFilter == null) _prefabTagFilter = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabTagFilter>();
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.PrefabTagDatabase;
        }
        #endregion
