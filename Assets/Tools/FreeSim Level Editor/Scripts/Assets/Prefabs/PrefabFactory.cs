    ...
    public static class PrefabFactory
    {
        ...
        public static Prefab CreateFromSelectedObjects(Pivot prefabPivot)
        {
            ...
            foreach(GameObject gameObject in allSelectedObjects)
            {
                ...
                GameObject gameObjectClone = FreeSimWorldBuilder.Instantiate(gameObject, gameObjectTransform.position, gameObjectTransform.rotation) as GameObject;
            ...
            FreeSimWorldBuilder.DestroyImmediate(prefabRoot);
            PrefabManagementWindow.Get().RepaintFreeSimWindow();
