...
namespace FreeSimEditor
{
    ...
    public class Prefab : INamedEntity
    {
        ...
        public PrefabInstantiationSettings InstantiationSettings
        {
            get
            {
                if (_instantiationSettings == null) _instantiationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabInstantiationSettings>();
        ...
        public PrefabActivationSettings ActivationSettings
        {
            get
            {
                if (_activationSettings == null) _activationSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabActivationSettings>();
