...
namespace FreeSimEditor
{
    ...
    public class PrefabPreviewGenerator
    {
        ...
        public static PrefabPreviewGenerator Get() { return FreeSimWorldBuilder.ActiveInstance.PrefabPreviewGenerator; }
        ...
        public void BeginPreviewGenSession()
        {
            ...
            List<Light> sceneLights = FreeSimScene.Get().GetSceneLights();
        ...
        public Texture2D GeneratePreview(Prefab prefab)
        {
            ...
            Sphere sceneSphere = FreeSimWorldBuilder.ActiveInstance.FreeSimScene.GetEncapuslatingSphere();
            ...
            if (previewMesh != null)
            {
                FreeSimMesh octaveMesh = FreeSimMeshDatabase.Get().GetFreeSimMesh(previewMesh);
