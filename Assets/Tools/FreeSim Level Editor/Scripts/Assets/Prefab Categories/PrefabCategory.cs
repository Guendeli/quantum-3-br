...
namespace FreeSimEditor
{
    public class PrefabCategory : ScriptableObject, INamedEntity
    {
        ...
        public PrefabFilter PrefabFilter
        {
            get
            {
                if (_prefabFilter == null) _prefabFilter = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabFilter>();
        ...
        {
            if (objectGroup == null || !FreeSimWorldBuilder.ActiveInstance.PlacementObjectGroupDatabase.ContainsObjectGroup(objectGroup)) return;
