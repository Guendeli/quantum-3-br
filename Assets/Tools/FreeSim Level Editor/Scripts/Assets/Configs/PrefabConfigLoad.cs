...
namespace FreeSimEditor
{
    public static class PrefabConfigLoad
    {
        ...
        {
            PrefabCategoryPrefabScrollViewData lookAndFeelData = FreeSimWorldBuilder.ActiveInstance.EditorWindowPool.ActivePrefabCategoryView.PrefabScrollView.ViewData;
