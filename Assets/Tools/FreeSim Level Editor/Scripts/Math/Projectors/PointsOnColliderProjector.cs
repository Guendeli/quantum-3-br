...
namespace FreeSimEditor
{
    public class PointsOnColliderProjector
    {
        ...
        private FreeSimCollider _collider;
        ...
        public FreeSimCollider Collider { get { return _collider; } set { if (value != null) _collider = value; } }
        ...
        public PointsOnColliderProjector(FreeSimCollider collider, Plane planeOfPointsToProject)
        {
            _collider = collider;
