    ...
    public abstract class SceneViewEventHandler
    {
        ...
        public void HandleSceneViewEvent(Event e)
        {
            ...
            switch(e.type)
            {
                ...
                case EventType.MouseDown:
                    ...
                    // Always disable the left mouse button down event in order to avoid deselecting the FreeSim object.
                ...
                case EventType.KeyDown:
                    ...
                    // Always disable the 'Delete' key in order to avoid deleting the FreeSim object from the scene.
                    ...
                    {
                        FreeSimWorldBuilder activeInstance = FreeSimWorldBuilder.ActiveInstance;
        ...
        private bool HandleGeneralShortcutKeys(Event e)
        {
            ...
            if(e.type == EventType.KeyDown)
            {
                ...
                {
                    e.DisableInSceneView();
                    UndoEx.RecordForToolAction(FreeSimWorldBuilder.ActiveInstance.Inspector);
                    FreeSimWorldBuilder.ActiveInstance.Inspector.ActiveInspectorGUIIdentifier = InspectorGUIIdentifier.ObjectPlacement;
                    return true;
                }
                else 
                if(AllShortcutCombos.Instance.ActivateObjectSelectionGUI.IsActive())
                {
                    e.DisableInSceneView();
                    UndoEx.RecordForToolAction(FreeSimWorldBuilder.ActiveInstance.Inspector);
                    FreeSimWorldBuilder.ActiveInstance.Inspector.ActiveInspectorGUIIdentifier = InspectorGUIIdentifier.ObjectSelection;
                    return true;
                }
                else
                if(AllShortcutCombos.Instance.ActivateObjectErasingGUI.IsActive())
                {
                    e.DisableInSceneView();
                    UndoEx.RecordForToolAction(FreeSimWorldBuilder.ActiveInstance.Inspector);
                    FreeSimWorldBuilder.ActiveInstance.Inspector.ActiveInspectorGUIIdentifier = InspectorGUIIdentifier.ObjectErase;
                    return true;
                }
            }
