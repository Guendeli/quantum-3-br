...
namespace FreeSimEditor
{
    ...
    public class PrefabsToPathTileConectionDropEventHandler : DragAndDropEventHandler
    {
        ...
        public PrefabsToPathTileConectionButtonDropSettings DropSettings
        {
            get
            {
                if (_dropSettings == null) _dropSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabsToPathTileConectionButtonDropSettings>();
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.PrefabsToPathTileConectionDropEventHandler;
        }
        #endregion
