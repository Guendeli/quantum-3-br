...
namespace FreeSimEditor
{
    ...
    public class PrefabsToCategoryDropEventHandler : DragAndDropEventHandler
    {
        ...
        public PrefabsToCategoryDropSettings PrefabsDropSettings
        {
            get
            {
                if (_prefabsDropSettings == null) _prefabsDropSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabsToCategoryDropSettings>();
        ...
        public PrefabFoldersToCategoryDropSettings PrefabFoldersDropSettings
        {
            get
            {
                if (_prefabFoldersDropSettings == null) _prefabFoldersDropSettings = FreeSimWorldBuilder.ActiveInstance.CreateScriptableObject<PrefabFoldersToCategoryDropSettings>();
        ...
        {
            return FreeSimWorldBuilder.ActiveInstance.PrefabsToCategoryDropEventHandler;
        }
        #endregion
        ...
        protected override void PerformDrop()
        {
            ...
            PrefabTagsWindow.Get().RepaintFreeSimWindow();
        }
        #endregion
