...
{
    [Serializable]
    public class FreeSimScene : IMessageListener
    {
        ...
        [SerializeField]
        private FreeSimMeshDatabase _octave3DMeshDatabase = new FreeSimMeshDatabase();
        ...
        public FreeSimMeshDatabase FreeSimMeshDatabase { get { return _octave3DMeshDatabase; } }
        #endregion

        #region Constructors
        public FreeSimScene()
        {
            MessageListenerRegistration.PerformRegistrationForFreeSimScene(this);
        ...
        public static FreeSimScene Get()
        {
            return FreeSimWorldBuilder.ActiveInstance.FreeSimScene;
        }
        #endregion
        ...
        public bool ObjectMeshIntersectsAnyMesh(GameObject queryMeshObject, TransformMatrix worldMatrix, List<GameObject> ignoreObjects)
        {
            ...
            FreeSimMesh octave3DMesh = queryMeshObject.GetFreeSimMesh();
        ...
        {
            var allWorkingObjects = FreeSimWorldBuilder.ActiveInstance.GetAllWorkingObjects();
