...
namespace FreeSimEditor
{
    public class MeshCombiner
    {
        ...
        public void CombineSelectedObjects(List<GameObject> selectedObjects, List<GameObject> ignoreObjects)
        {
            ...
            if (meshCombineMaterials == null || meshCombineMaterials.Count == 0)
            {
        ...
        private List<MeshCombineMaterial> GetMeshCombineMaterials(List<GameObject> meshObjects, GameObject sourceParent)
        {
            ...
            foreach (var meshObject in meshObjects)
            {
                ...
                for (int submeshIndex = 0; submeshIndex < sharedMesh.subMeshCount; ++submeshIndex)
                {
                    ...
                    Material subMeshMaterial =  (submeshIndex <= meshRenderer.sharedMaterials.Length - 1) ? meshRenderer.sharedMaterials[submeshIndex] : meshRenderer.sharedMaterials[0];
        ...
        {
            string absoluteFolderPath = FileSystem.GetToolFolderName() + "/FreeSim Combined Meshes";
