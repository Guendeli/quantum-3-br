...
namespace FreeSimEditor
{
    public static class ObjectActions
    {
        ...
        {
            var roots = FreeSimWorldBuilder.ActiveInstance.GetRoots(gameObjects);
        ...
        {
            List<GameObject> sourceParents = FreeSimWorldBuilder.ActiveInstance.GetRoots(sourceObjects);
        ...
        public static List<GameObject> ReplaceGameObjectHierarchyCollectionPrefab(List<GameObject> gameObjectCollection, GameObject newPrefab)
        {
            ...
            List<GameObject> roots = FreeSimWorldBuilder.ActiveInstance.GetRoots(gameObjectCollection);
        ...
        public static GameObject ReplaceGameObjectHierarchyPrefab(GameObject gameObject, GameObject newPrefab)
        {
            ...
            if (newObject != null)
            {
                ...
                FreeSimScene.Get().RegisterObjectHierarchy(newObject);
