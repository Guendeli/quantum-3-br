...
namespace Quantum {
  ...
  public unsafe partial class Frame {
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          case EventOnDamageHit.ID: result = typeof(EventOnDamageHit); return;
      ...
      public EventOnDamageHit OnDamageHit(EntityRef entityRef, FP maxHealth, FP currentHealth) {
        var ev = _f.Context.AcquireEvent<EventOnDamageHit>(EventOnDamageHit.ID);
  ...
  public unsafe partial class EventOnDamageHit : EventBase {
    public new const Int32 ID = 1;
    public EntityRef entityRef;
    public FP maxHealth;
    public FP currentHealth;
    protected EventOnDamageHit(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventOnDamageHit() : 
